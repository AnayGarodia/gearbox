...
export interface Theme {
  ...
  // The "card" language (no drawn borders — structure from background layers):
  //   headerBg = a card/diff/panel header bar, one step brighter than the card
  //   chipBg   = a pill/badge surface (status facts, language chips, route tags)
  headerBg: string;
  chipBg: string;
  accentBg: string;
...
export const light: Theme = {
  ...
  userBg: "#E3F0F9", codeBg: "#F3F4F6", panelBg: "#F3F4F6", elementBg: "#E9EBEE", headerBg: "#E0E3E8", chipBg: "#DDE0E6", accentBg: "#DFF3F6", selBg: "#B5D5F0", selInk: "#16191F",
  path: "#1E6091",
...
export const gruvbox: Theme = {
  ...
  userBg: "#3C3836", codeBg: "#32302F", panelBg: "#32302F", elementBg: "#3C3836", headerBg: "#413B36", chipBg: "#473F38", accentBg: "#2E3B33", selBg: "#665C54", selInk: "#FBF1C7",
  path: "#83A598",
...
export const catppuccin: Theme = {
  ...
  userBg: "#202A3C", codeBg: "#313244", panelBg: "#313244", elementBg: "#45475A", headerBg: "#3A3C52", chipBg: "#414364", accentBg: "#203437", selBg: "#585B70", selInk: "#F5F7FF",
  path: "#89B4FA",
...
export const contrast: Theme = {
  ...
  userBg: "#002B40", codeBg: "#101010", panelBg: "#101010", elementBg: "#1C1C1C", headerBg: "#1F1F1F", chipBg: "#262626", accentBg: "#003A3A", selBg: "#0066CC", selInk: "#FFFFFF",
  path: "#66B3FF",
