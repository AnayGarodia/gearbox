...
export const PROFILES: ModelProfile[] = [
  {
    id: "claude-sonnet-4-6", provider: "anthropic", contextWindow: 200_000, maxOutput: 64_000,
    ...
    strengths: ["agentic coding", "tool use", "instruction-following", "long-horizon tasks"],
  ...
  {
    id: "gpt-5.4", provider: "openai", contextWindow: 256_000, maxOutput: 64_000,
    tokenizer: TIKTOKEN,
    cost: { inUSDPerMtok: 2.5, outUSDPerMtok: 10, src: "seeded" },
    latency: { ttftMs: 0, tps: 0, src: "seeded" },
    quality: { sweBenchVerified: 0.75, intelligenceIndex: 55, src: "researched" },
    strengths: ["strong reasoning", "broad knowledge"],
    weaknesses: ["pricier output"],
    asOf: "2026-06",
  },
  {
    id: "gemini-2.5-pro", provider: "google", contextWindow: 1_000_000, maxOutput: 64_000,
    tokenizer: GEMINI_TOK,
    cost: { inUSDPerMtok: 1.25, outUSDPerMtok: 10, src: "researched" },
    latency: { ttftMs: 0, tps: 0, src: "seeded" },
    quality: { sweBenchVerified: 0.718, intelligenceIndex: 52, src: "researched" },
    strengths: ["huge 1M context", "strong reasoning (GPQA)", "good price/intelligence"],
    weaknesses: ["agentic tool-use historically behind Claude"],
    asOf: "2026-06",
  },
  {
    id: "gemini-2.5-flash", provider: "google", contextWindow: 1_000_000, maxOutput: 64_000,
    tokenizer: GEMINI_TOK,
    cost: { inUSDPerMtok: 0.3, outUSDPerMtok: 2.5, src: "seeded" },
    latency: { ttftMs: 0, tps: 0, src: "seeded" },
    quality: { intelligenceIndex: 40, src: "seeded" },
    strengths: ["very cheap", "fast", "1M context", "good for bulk/grunt sub-tasks"],
    weaknesses: ["lower ceiling on hard tasks"],
    asOf: "2026-06",
  },
  {
    id: "deepseek-chat", provider: "deepseek", contextWindow: 128_000, maxOutput: 8_000,
    tokenizer: DEEPSEEK_TOK,
    cost: { inUSDPerMtok: 0.28, outUSDPerMtok: 0.42, src: "researched" },
    latency: { ttftMs: 0, tps: 0, src: "seeded" },
    quality: { sweBenchVerified: 0.806, intelligenceIndex: 48, src: "researched" },
    strengths: ["~50× cheaper input than frontier", "strong coding for the price"],
