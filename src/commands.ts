...
export const COMMANDS: CommandMeta[] = [
  ...
  { name: "/tab", usage: "/tab [new|run <task>|fork|merge|<n>|close]", desc: "parallel session tabs (own worktree each) · run starts a task · fork clones this chat · merge lands the branch", group: "chat" },
  ...
  { name: "/compact", usage: "/compact [focus]", desc: "shrink the conversation, optionally preserving a focused thread", group: "chat" },
  ...
  { name: "/cost", usage: "/cost", desc: "the money story: 7-day spend, per-model & per-account breakdowns, savings", group: "accounts" },
  ...
  { name: "/proceed", usage: "/proceed", desc: "approve the plan and build it (exits plan mode)", group: "modes" },
