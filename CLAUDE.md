...
src/
  ...
  tools.ts           read_file / write_file / edit_file / list_dir / search / glob / run_shell / fetch_url / web_search (AI SDK tools; createToolset merges MCP + delegate tools)
